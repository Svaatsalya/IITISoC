export const landingPageStyles = {
  ...
  desktopAuthButtonOverlay: "absolute inset-0  bg-gradient-to-r from-pink-500 via-white/30 to-purple-300 opacity-0 group-hover:opacity-100 transition-opacity",
  ...
  mobileDashboardButton: "w-full px-6 py-3 bg-gradient-to-r from-purple-700 via-fuchsia-600 to-pink-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  ...
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-pink-500 via-white/30 to-purple-300 opacity-0 group-hover:opacity-100 transition-opacity",
...
export const dashboardStyles = {
  // Container
 container: "container mx-auto px-6 lg:px-12 py-10",

  // Header
 headerWrapper: "flex flex-col lg:flex-row items-center lg:items-center justify-between gap-6 w-full max-w-7xl mx-auto px-4 md:px-8 py-6 border-2 border-purple-500 rounded-xl shadow-[0_0_10px_#9b5de5,0_0_20px_#f15bb5] p-6",

headerTitle: "text-3xl font-extrabold text-white",
headerSubtitle: "text-gray-400 text-base",
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-purple-700 via-fuchsia-600 to-pink-500 text-white font-bold rounded-2xl overflow-hidden transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_8px_30px_rgb(121,40,202,0.5)]",

createButtonOverlay: "absolute inset-0 bg-gradient-to-r from-pink-500 via-white/30 to-purple-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm",

createButtonContent: "relative flex items-center gap-3 tracking-wide text-lg",


  // Loading
  spinnerWrapper: "flex justify-center items-center py-12",

  spinner: "animate-spin h-14 w-14 rounded-full border-[3px] border-t-transparent border-l-violet-400 border-b-pink-500 border-r-transparent shadow-[0_0_12px_rgba(168,85,247,0.5)]",
...
export const cardStyles = {
  ...
  profileCard:
    "flex items-center gap-3 px-3 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.03]",
  profileInitialsContainer:
    "w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-xl flex items-center justify-center shadow-md",
  profileInitialsText: "text-base sm:text-lg font-bold text-white",
  profileName: "text-sm sm:text-base font-semibold text-white",
  logoutButton:
    "text-xs sm:text-sm font-medium text-fuchsia-400 hover:text-fuchsia-300 transition",
