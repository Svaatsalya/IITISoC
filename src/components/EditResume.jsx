...
const EditResume = () => {
  ...
  const renderForm = () => {
   ...
   const updateSection = (section, key, value) => {
    ...
    //update array state using index
  ...
  //It helps in choosing the preview as well as helps in downloading the resume also saves the resumes as images
    ...
    //This function will help in updating the resume and put will help in updation on the backend side 
  ...
  useEffect(() => {
    ...
    //so all these function will be used to edit resumes 
  return (
              ...
              <div className={containerStyles.formContainer}>
                ...
                <div className='p-4 sm:p-6'>
                  ...
                  <div className='hidden lg:block'>
                    ...
                    {/* modal data here */}
                    <ModalLS isOpen={openThemeSelector} onClose={()=> setOpenThemeSelector(false)}
                      title="Change Title">
                    ...
                    <ModalLS isOpen={openPreviewModal} onClose={()=> setOpenPreviewModal(false)}
                                ...
                                <div className={containerStyles.pdfPreview}>
                                  <div ref={resumeDownloadRef} className='a4-wrapper'>
                                    <div className='w-full h-full'>
                                      <RenderResume key={`pdf-${resumeData?.theme || ""}`}
                                      templateId={resumeData?.template?.theme || ""}
                                      resumeData={resumeData}
                                      containerWidth={null}
                                      />
