    ...
    const handleCreateResume = async (e) =>{
        ...
        try {
            ...
            if(error.response && error.response.data.message){
                ...
                setError("An error occurred while creating your resume. Please try again later");
            }
        }
    }   
  ...
  return (
    <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
        ...
        <form onSubmit={handleCreateResume}>
            ...
            label='Resume Title' placeholder='e.g. , Vaatsalya Sahu - Software Engineer' type='text' />
